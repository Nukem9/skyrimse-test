...
static_assert_offset(BSRenderPass, m_Property, 0x8);
static_assert_offset(BSRenderPass, m_Geometry, 0x10);
static_assert_offset(BSRenderPass, m_TechniqueID, 0x18);
static_assert_offset(BSRenderPass, Byte1C, 0x1C);
static_assert_offset(BSRenderPass, Byte1D, 0x1D);
static_assert_offset(BSRenderPass, m_Lod, 0x1E);
static_assert_offset(BSRenderPass, m_LightCount, 0x1F);
static_assert_offset(BSRenderPass, Word20, 0x20);
static_assert_offset(BSRenderPass, m_Previous, 0x28);
static_assert_offset(BSRenderPass, m_Next, 0x30);
static_assert_offset(BSRenderPass, m_SceneLights, 0x38);
static_assert_offset(BSRenderPass, UnkDword40, 0x40);