...
public:
	...
	NiPointer<NiSourceTexture> spTerrainOverlayTexture;
	NiPointer<NiSourceTexture> spTerrainNoiseTexture;
...
static_assert_offset(BSLightingShaderMaterialLandscape, spTerrainOverlayTexture, 0xF8);
static_assert_offset(BSLightingShaderMaterialLandscape, spTerrainNoiseTexture, 0x100);
